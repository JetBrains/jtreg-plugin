...
data class TestVMSettings(
    var allowSecurityManager: Boolean = false,
    var javaOptions: String = "",
    var nativeLibPath: String = "",
    var envVars: Map<String?, String?> = mapOf(),
    var classPath: List<ModuleBasedConfigurationOptions.ClasspathModification> = listOf(),
    var useIdeaVMOptions: Boolean = false,
): Cloneable {
    ...
    override fun hashCode(): Int {
        return Comparing.hashcode(allowSecurityManager) xor
                Comparing.hashcode(javaOptions) xor
                Comparing.hashcode(nativeLibPath) xor
                Comparing.hashcode(envVars) xor
                Comparing.hashcode(classPath) xor
                Comparing.hashcode(useIdeaVMOptions)
    }
